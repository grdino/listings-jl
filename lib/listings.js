export const LISTINGS = {
  ...
  "1-bedroom-condo-for-sale-zona-romantica-puerto-vallarta-madero-320-305": {
    ...
    title: "1 Bedroom, 2-bath Condo for Sale in Zona Romántica, Puerto Vallarta – Madero 320 #305",
    subtitle:
      "Luxurious Urban Oasis • Heart of Zona Romántica",
    priceText: "$575,000 USD",
    seoDescription:
    "1 Bedroom, 2-bath Condo for Sale in Zona Romántica, Puerto Vallarta – Madero 320 #305 with ~1,064 sq ft, private terrace, walkable location, and close proximity to the beach.",
    seoIntro:
    "This 1 Bedroom, 2-bath Condo for Sale in Zona Romántica, Puerto Vallarta – Madero 320 #305 offers a rare combination of quiet indoor-outdoor living in the heart of Zona Romántica, Puerto Vallarta. Located just steps from restaurants, galleries, nightlife, and the beach, this furnished residence features approximately 1,064 square feet, upscale finishes, a spacious private terrace, and a layout ideal for full-time living, a second home, or a vacation rental investment. Buyers searching for a condo for sale in Zona Romántica will appreciate the walkable location, quality construction, and strong lock-and-leave appeal.",
    facts: [
      { label: "Bedrooms", value: "1" },
      { label: "Bathrooms", value: "2" },
